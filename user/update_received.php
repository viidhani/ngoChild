...
if(isset($_POST["submit"]))
{
    ...
    $update = $obj->Query("update donation_user set status='Received',remarks='$remarks' where donation_id='$donationid'");

    
        $obj->query("INSERT INTO `accept_donation`(`donation_id`, `volunteer_id`, `donor_id`, `received_datetime`, `received_remarks`) VALUES ('$donationid','$userid','$donor_id','$datetime','$remarks')  ");
    ...
    if($update)
      ...
      else
      {
        ...
        echo "<script>alert('Error In Code');document.location='update_received.php';</script>";
      }
}
?>
                ...
                <div class="row">
                    ...
                    <div style="padding:20px" class="col-sm-7">
                        <form method="post"> 
                            ...
                            <div  class="row cont-row">
                                <div  class="col-sm-3"><label>Received Time</label><span>:</span></div>
                                <div class="col-sm-8">
                                    <input type="time" id="received_time" name="received_time" placeholder="Enter Received Time Here" class="form-control input-sm">
                                </div>
                            </div>
                            ...
                            <div  class="row cont-row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" class="form-control input-sm" placeholder="Received"  disabled value="Received" >
                                </div>
                            </div><br>
                            ...
                            <div  class="row cont-row">
                                ...
                                <div style="margin-top:10px;" class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <button class="btn btn-primary btn-sm" name="submit" id="submit" value="submit">Donation Received</button>                        
                                    </div>
                                </div>
                            </form>
                        </div>
