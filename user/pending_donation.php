...
$selectdonation = $obj->Query("SELECT * from donation_user where area_id ='$area' and status='Pending'");
                ...
                <div class="card m-5 " style="width:80%; ">
                             ...
                             <h5 class="card-title">Donations Collection Details</h5>
                                        ...
                                        <tr class="table-success">
                                            ...
                                            <a href="update_accept.php?eid=<?php echo $row->donation_id; ?>">Change Status</a>
                                            </td>                                          
                                        </tr>
                                        <?php  
                                    }
