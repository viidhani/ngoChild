...
$selectdonation = $obj->Query("SELECT * from donation_user where area_id ='$area' and status='Accept'");
...
<!doctype html>
    ...
    <body>
        ...
        <div class="page-nav no-margin row">
            <div class="container">
                <div class="row">
                    <h2>Accepted Donation Details</h2>
                    <ul>
                        <li> <a href="#"><i class="fas fa-home"></i> Home</a></li>
                        <li><i class="fas fa-angle-double-right"></i>Accepted Donation</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card m-5 " style="width:80%; ">
                             ...
                             <h5 class="card-title">Donations Collection Details</h5>
                                        ...
                                        <tr class="table-success">
                                            ...
                                            <a href="update_received.php?eid=<?php echo $row->donation_id; ?>">Change Status</a>
                                            </td>                                          
                                        </tr>
                                        <?php  
                                    }
